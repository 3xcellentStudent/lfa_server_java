...
public class MailerController {
  ...
  @PostMapping("/send")
  public ResponseEntity<Object> sendEmail(@RequestBody ReceivedPdfAndEmailDataDto body){
    // try {
      ...
      byte[] fileBytes = body.getFileBytes();
      ReceivedPdfAndEmailDataDto.EmailContent emailContent = body.getEmailContent();
